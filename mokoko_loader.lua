-- Kaynak: https://v3rmillion.net/showthread.php?tid=1116257
...
function RUN_FUNCTION(name, extension, configOpt)
    ...
    spawn(function()
        ...
        Title.Text = name or "MOKOKO HUB | Loader"
        ...
        Message.Text = settings.StartMessage or "Hosgeldin, " .. game:GetService("Players").LocalPlayer.Name
